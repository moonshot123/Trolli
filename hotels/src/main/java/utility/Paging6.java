...
public class Paging6 {
	...
	public Paging6(String _pageNumber, String _pageSize, int totalCount, String url, String whatColumn, String keyword, int membernum) {
	...
	private String getPagingHtml(String url) { // 페이징 문자열을 만든다.
		...
		if (this.beginPage != 1) { // 앞쪽, pageSize:한 화면에 보이는 레코드 수
			result += "&nbsp;<a href='" + url + "?pageNumber=" + (1) + "&pageSize=" + this.pageSize
		...
		for (int i = this.beginPage; i <= this.endPage; i++) {
			if (i == this.pageNumber) {
				...
				result += "&nbsp;<a href='" + url + "?pageNumber=" + i + "&pageSize=" + this.pageSize 
		...
		System.out.println();
		// result:&nbsp;<a
		// href='/ex/list.ab?pageNumber=1&pageSize=2&whatColumn=null&keyword=null'>1</a>&nbsp;&nbsp;<font
		// color='red'>2</font>&nbsp;&nbsp;<a
		// href='/ex/list.ab?pageNumber=3&pageSize=2&whatColumn=null&keyword=null'>3</a>&nbsp;
