...
<body>
	...
	<div class="col-md-4">
	<fieldset>
	<legend><b>패스워드 찾기</b></legend>
		<form:form commandName="member" method="post" action="findPW.mem">
			
			<div class="col-md-12">	
				<label for="memberid" class="col-lg-3 control-label"><b>아이디</b></label> 
				<input type="text" name="memberid" placeholder="가입하신 아이디를 입력하세요." class="form-control">
			</div>	
			<div class="col-md-12">
			...
			<div class="alert alert-dismissible alert-danger">
  			...
  			<h4>비밀번호 찾는 방법!</h4>
  			<p>회원정보에 등록한 아이디와 입력한 이름, 이메일 주소가 모두 동일해야, 비밀번호를 찾을 수 있습니다.</p>
			</div>	
